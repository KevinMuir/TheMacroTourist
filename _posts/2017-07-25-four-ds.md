...
Yeah, I get it.  These are definitely valid themes to consider when designing your portfolio.  And don't mistake my push back - I don't have any problem with the assertion that debt, deflation, and demographics, are the most important factors affecting the current financial environment.  I have a problem with the part on the right hand side of the equal sign.
...
Yet I am not as sure that this conclusion is quite as obvious as many of these strategist assert.  Yes, there is no doubt that these will be meaningful factors affecting the financial system in coming years and decades.  But how can they be so confident about the outcome?
...
To argue the opposite would imply that Volcker's response to inflation in the 1970's was not the reason for the dramatic decline in inflation, but instead just a strange coincidence.  Or that Greenspan's easy money didn't contribute to the DotCom bubble.
